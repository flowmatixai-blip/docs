...
![251 Website Contacts Meta Data  Flowmatix Resource C 1 Pn](/images/api-references/website-contact-metadata/251.website_contacts__meta_data__Flowmatix_resource_c-1.png)
...
https://page. Flowmatix.com/BotId/CustomerId
...
<script id=" Flowmatix-messenger-widget" src="https://cdn. Flowmatix.com/ Flowmatix.js" defer>BotId,CustomerId</script>
...
`PUT` `https://api.v7. Flowmatix.com/inbox/direct/lead`
...
`GET` `https://api.v7. Flowmatix.com/inbox/direct/chats`
    ...
    "data": [
        {
            ...
            "lastMessage": {
                ...
                "by": "bot",
                "text": "Welcome to  Flowmatix. I am here to help you."
            },

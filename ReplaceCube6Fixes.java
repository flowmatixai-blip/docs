...
public class ReplaceFlowmatixFixes {
    public static void main(String[] args) {
        ...
        try (Stream<Path> pathStream = Files.walk(folderPath)) {
            List<Path> allTextFiles = pathStream
                    ...
                    .filter(ReplaceFlowmatixFixes::isTextFile)
    ...
    private static boolean processFile(Path filePath) {
        try {
            ...
            String updated = content
                    .replace("_ Flowmatix", "_Flowmatix")
                    .replace("how- Flowmatix-works", "how-botpenguin-works");

...
<AccordionGroup>
  <Accordion title="How do we collect country, city, mobile number and other metadata">
    1. Flowmatix fetches the country and city of a visitor from their IP Address.
  ...
  <Accordion title="How can you call customers with call feature in lead section">
    Flowmatix offers an integration with Twilio to call your leads from the Inbox. You can use the call feature to call leads and customers from the leads section directly from your desktop. You must integrate Twilio with  Flowmatix to set up the calling feature in  Flowmatix.
  </Accordion>
  <Accordion title="How to integrate Twillo">
    ...
    2. To complete the Integration, you need:-
       ...
       5. URL (POST)
    1. You can find all of these credentials on the Twilio Dashboard.
    2. Also, you can contact us at support@flowmatix.ai for further assistance.
    3. After you fill out these parameters, you can quickly call leads from  Flowmatix.
    4. Refer To The Following Steps To Obtain Your API Key and SID On Twilio
  ...
  <Accordion title="What are quick replies and how does it work">
    ...
    You can add quick replies in the  Flowmatixon app by following steps:
  ...
  <Accordion title="How to transfer chat to WhatsApp">
    1. Flowmatix offers you the option to transfer the chat to WhatsApp or an agent on your support team.
  ...
  <Accordion title="How are segments created">
    ...
    1. You can create segments based on their characteristics like demographics, behaviors, interests
  </Accordion>

...
<AccordionGroup>
  <Accordion title="How to change my email ID">
    You cannot change your email address once you have created your account from the  Flowmatix app. However, You can contact  Flowmatix at [support@ Flowmatix.com](mailto:support@ Flowmatix.com)[.](mailto:support@ Flowmatix.com) to change your email address.
  </Accordion>
  <Accordion title="How to delete my  Flowmatix account">
    Once you login to your  Flowmatix account

    1. Navigate to "My Account" section and then click on 'Password" settings.
    2. Here ye can see a button named "Delete Account". Click on that to delete your  Flowmatix Account
  </Accordion>
  ...
  <Accordion title="How can a new team member log into the  Flowmatix">
    ...
    4. For example, A New Team member here will log in on [app. Flowmatix.com](http://app. Flowmatix.com) from their email address [xyz@gmail.com](mailto:xyz@gmail.com) and the password above.
  </Accordion>
</AccordionGroup>
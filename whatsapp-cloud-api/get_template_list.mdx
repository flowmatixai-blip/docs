...
```
https://api.v7. Flowmatix.com/whatsapp-automation/wa/templates?apiKey=*API KEY*
```
...
```
curl --location --request GET 'https://api.v7. Flowmatix.com/whatsapp-automation/wa/templates?apiKey=*API KEY*' \\

...
description: "This guide will tell you how you can access the API Token on the  Flowmatix Platform"
---

## **What is API Access Token**

**API Access Token** is a secure key that allows developers to interact with Flowmatix's platform APIs. It is used for authenticating third-party or custom applications with Flowmatix's services. The token acts as a password for machines, enabling secure access without manual logins.

---

## **Benefits of using the API Access Token Section**

- **Secure access** to Flowmatix's backend APIs without exposing your login credentials.

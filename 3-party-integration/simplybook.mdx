---
title: "Integrate  Flowmatix with SimplyBook"
description: "This page contains the stepwise tutorial for the integration of SimplyBook with  Flowmatix."
---

**\
Access Your  Flowmatix Account**

- Log in to your  Flowmatix account and select the bot you wish to integrate with SimplyBook.

**\
Navigate to Third-Party App Integrations**

- Go to the "Third-Party App Integrations" section in your  Flowmatix account.

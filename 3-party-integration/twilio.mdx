---
title: "Integrate  Flowmatix with Twilio"
description: "This page provides a step-by-step guide on integration of  Flowmatix with Twilio"
---

### **Why use Twilio?**

Integrate Twilio with your  Flowmatix chatbot to enable seamless SMS and WhatsApp messaging. This allows your chatbot to reach users directly on their phones, improving engagement, outreach, and customer satisfaction. Whether you're sending order updates or automating lead follow-ups, Twilio ensures reliable delivery.
...
- Your  Flowmatix chatbot is published and assigned to a valid channel.

---

### **Steps to Integrate  Flowmatix with Twilio:**

#### **Step 1: Going to Integration on  Flowmatix**

1. Sign into your  Flowmatix account and choose the chatbot. Go to "Third Party Apps Integrations"
2. \
...
#### **Step 2: Getting the Information from Twilio.**
 ...
 5. \
    Copy and paste the same tokens in the  Flowmatix Applciation.
 ...
 7. \
    ...
    - Set the name as " Flowmatix".
    - Copy the code in  Flowmatix Twilio Integration Screen, and paste it in the Request URL box.
 8. \
    This will create a new application.
 9. Click on the application to see the **TwiLM App SID**. Copy the ID over to the  Flowmatix platform.
10. \
...
14. \
    Copy the same in your  Flowmatix Account.
15. \
...
17. \
    Make sure both the "Voice Configuration", and scrolling down, the Messaging Configuration have the URL as copied from  Flowmatix.
18. \
...
<AccordionGroup>
  <Accordion title="Does  Flowmatix offer SMS services with Twilio">
    No,  Flowmatix only offers Twilio with Voice calling configuration.
  </Accordion>

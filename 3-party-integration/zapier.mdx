---
title: "Integrate  Flowmatix with Zapier"
description: "This page contains the step wise tutorial for the integration of Zoho CRM with  Flowmatix."
---

### **What is Zapier.**

Zapier is an automation tool which helps making a connecting between apps. You can set  Flowmatix and apps in zapier as triggers and actions.

---

### **Benifits of using Zapier:**

- **Seamless Automation:** Instantly connect  Flowmatix with thousands of apps without custom coding.
...
### **Steps to use  Flowmatix with Zapier**

 1. Log in to your  Flowmatix account and select a bot you wish to integrate with Zapier.
 ...
 4. Then go to Zapier website.
    ...
    [ Flowmatix Integrations | Connect Your Apps with ZapierZapier](https://zapier.com/apps/ Flowmatix/integrations)
 5. Here you can see all the supported Triggers and Actions that are available to be used with  Flowmatix.
...
11. Select  Flowmatix from the list as trigger.
12. Then select a trigger event from the list of available events.
13. After that click on "Sign In" to connect  Flowmatix.
14. \
    When you click on sign in, a pop will be opened to give zapier access to your  Flowmatix account.
15. Select the platform / bot channel for which you want to use zapier
16. Then enter the API Key which is available in Developers section inside Access Token in  Flowmatix.
17. Then enter the Bot Id, you can click on "edit" in Zapier Integration Page to get Bot Id for the same.
18. And click "Yes Continue with  Flowmatix".
...
**Similarly you can use other apps as TRIGGERS and  Flowmatix as ACTION**

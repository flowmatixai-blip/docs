---
title: "Integrate  Flowmatix with Razorpay"
description: "This page contains al the necessary information on how you can interate the Razorpay with Botepenguin"
---

### **Prerequisites**

To successfully integrate Razorpay with  Flowmatix, you will need:

- A ** Flowmatix** account.
- A **Razorpay** account.
- A **WhatsApp bot**

This integration enables your WhatsApp bot created on  Flowmatix to collect payments via Razorpay.

#### **Step 1: Login to  Flowmatix and Select WhatsApp Bot**

1. Go to [ Flowmatix](https://www. Flowmatix.com/) and log into your account.
...
To connect Razorpay with  Flowmatix, you need the **Client ID** and **Client Secret** from your Razorpay account.
...
#### **Step 4: Connect Razorpay to  Flowmatix**
...
4. Go back to  Flowmatix and copy the **Webhook URL** from the integration settings.
...
1. Navigate back to your  Flowmatix bot editor.
2. \
...
Your  Flowmatix WhatsApp bot is now successfully integrated with Razorpay. You can collect payments seamlessly and track payment events through the configured webhooks. This integration ensures a smooth payment experience for your users directly through WhatsApp.   